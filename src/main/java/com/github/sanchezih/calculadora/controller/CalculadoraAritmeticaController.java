...
public class CalculadoraAritmeticaController {
  ...
  @RequestMapping(value = "/restar", method = RequestMethod.GET, params = {"operando1",
      "operando2"})
  ...
  @RequestMapping(value = "/multiplicar", method = RequestMethod.GET, params = {"operando1",
      "operando2"})
  ...
  @RequestMapping(value = "/dividir", method = RequestMethod.GET, params = {"operando1",
      "operando2"})
